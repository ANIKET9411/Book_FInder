...
function Section_3() {
  ...
  const fantasy = useSelector((state) => state.fantasyReducer);
  useEffect(() => {
    async function getApi() {
      dispatch({ type: "remove_fantasy" });
      const url =
        "https://www.googleapis.com/books/v1/volumes?q=subject:fantasy&maxResults=30";
      ...
      dispatch({ type: "update_fantasy", payload: newdata });
    }
    getApi();
  }, []);
