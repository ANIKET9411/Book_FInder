...
function Section_2() {
  ...
  const nonFiction = useSelector((state) => state.nonfictionReducer);
  useEffect(() => {
    async function getApi() {
      dispatch({ type: "remove_nonfiction" });
      const url =
      ...
      dispatch({ type: "update_nonfiction", payload: newdata });
    }
    getApi();
  }, []);
